...
function InventoryList({ inventoryList, displayWarehouse }) {
  ...
  return (
    <div
      className={
        displayWarehouse ? "inventory overlap" : "inventory overlap-disable"
      }
    >
      {displayWarehouse && (
        <form className="inventory__form">
          ...
          <div key="999" className="inventory__header-right">
            <input
              ...
              ref={searchRef}
            />
            <button className="inventory__button" onClick={handleAddItem}>
              + Add New Item
            </button>
          </div>
        </form>
        ...
        <li key="0" className="inventory__tablet-li">
          <div className="inventory__tablet-sectionwraper">
            ...
            <div
              className={
                displayWarehouse
                  ? "inventory__tablet-section--right"
                  : "inventory__tablet-section--right2"
              }
            >
              <div className="inventory__tablet-column">
              ...
              <li key={inventory.id} className="inventory__li">
                <div className="inventory__sectionwraper">
                  ...
                  <div
                    className={
                      displayWarehouse
                        ? "inventory__section--right"
                        : "inventory__section--right2"
                    }
                  >
                    <div className="inventory__column">
                      ...
                      <div
                        className={
                          inventory.status === "In Stock"
                            ? "inventory__status inventory__in-stock"
                            : "inventory__status inventory__out-of-stock"
                        }
                      >
